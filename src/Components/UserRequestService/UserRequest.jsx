  ...
  assignDutyOnServicePlan = async () => {
    ...
    if (this.state.doctorForm.vaccination) {
      ...
      if (servicePlan === "Weekly" || servicePlan === "Daily") {
        ...
        userRequest.repeatedMeetingsNo =
          parseInt(this.state.repeatedService.length) + 1;
        this.state.repeatedService.splice(0, 0, { date: doctorForm.schedule });
